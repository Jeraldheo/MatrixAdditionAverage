...
namespace TestMatrixAdditionAverage
{
    public class TestProgram
    {
        public static IEnumerable<object[]> TestDataComputeAverage
            => new[]
            {
                new object[]{20, new double[,]{ {17, 9, 36},{8, 7, 3}, {15, 28, 57} } },
                new object[]{10, new double[,]{ {20, 9, 12},{8, 7, 3}, {10, 20, 1} } },
                new object[]{0, new double[,]{ {0, 0, 0},{0, 0, 0}, {0, 0, 0} } },
                new object[]{9, new double[,]{ {9, 9, 9},{9, 9, 9}, {9, 9, 9} } }
            };
        [Theory]
        [MemberData(nameof(TestDataComputeAverage))]
        public void Test_ComputeAverage(double expectedAverage, double[,] matrix)
        {
